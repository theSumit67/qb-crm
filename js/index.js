...
$(".data-file-save").click(function() {
    setTimeout(function() {
        ...
        $('.cm-project-list ul').append('<li> <div class="cm-proj-mane"><a  href="#'+websiteNameSlug+'"><i class="fa fa-cube" aria-hidden="true"></i>'+websiteName+'</a></div><div class="cm-proj-option"><div class="edit"><i class="fas fa-edit"></i></div><div class="delete"><i class="far fa-trash-alt"></i></div></div></li>');
...
/*---------END Flex Modal---------*/
$(document).on('click', '.cm-project-list ul li', function(e) {
...
/*$(document).on('click', '.cm-proj-option', function(e) {
	e.stopPropagation();
    $(this).addClass('active-data').siblings().removeClass('active-data');
});*/
...
$(document).ready(function(){
	...
	$('.cm-project-list > ul > li').removeClass('active-data');
	$('a[href="'+getHref+'"]').closest('li').addClass('active-data');
});